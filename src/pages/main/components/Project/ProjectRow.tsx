...
type ProjectRowProps = {
  ...
  onProjectActionClick: (projectId: string, action: string) => void;
};
...
export default function ProjectRow({
  ...
  return (
    <>
      <tr>
        <td>{no}</td>
        <td className={styles.projectIdCell}>
          <div className={styles.projectIdWrapper}>
            ...
            <IconButton
              ...
              onClick={handleCopy}
            >
              <img src={CopyIcon} alt="Copy Project ID" />
            </IconButton>
          </div>
          <Snackbar
            open={open}
        ...
        <td className={styles.action_buttons}>
          <IconButton
            ...
            onClick={() => onProjectActionClick(projectId, "view")}
          >
            <RemoveRedEyeIcon className={styles.icon} />
          </IconButton>
          <IconButton
            className={styles.button}
            onClick={() => onProjectActionClick(projectId, "edit")}
          >
